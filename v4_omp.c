...
void cscParallelV4Omp(uint32_t *row, uint32_t *col, uint32_t *res, uint32_t nc) {
...
int main(int argc, char *argv[]) {
    ...
    runAndPresentResult(rowsCsc, colsCsc, nc, cscParallelV4Omp, "V4 Parallel OpenMP", "./v4-omp.txt", "./v4-omp-results.txt");
